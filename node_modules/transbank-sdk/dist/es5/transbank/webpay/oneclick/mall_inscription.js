...
var MallInscription = /** @class */ (function (_super) {
     ...
     */
    MallInscription.buildForIntegration = function (commerceCode, apiKey) {
        return new MallInscription(new options_1.default(commerceCode, apiKey, environment_1.default.Integration));
    };
    /**
     ...
     */
    MallInscription.buildForProduction = function (commerceCode, apiKey) {
        return new MallInscription(new options_1.default(commerceCode, apiKey, environment_1.default.Production));
    };
    /**
