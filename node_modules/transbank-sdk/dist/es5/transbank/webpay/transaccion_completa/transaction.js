...
var Transaction = /** @class */ (function (_super) {
     ...
     */
    Transaction.buildForIntegration = function (commerceCode, apiKey) {
        return new Transaction(new options_1.default(commerceCode, apiKey, environment_1.default.Integration));
    };
    /**
     ...
     */
    Transaction.buildForProduction = function (commerceCode, apiKey) {
        return new Transaction(new options_1.default(commerceCode, apiKey, environment_1.default.Production));
    };
    /**
     ...
     * a grace period.
     */
    Transaction.prototype.commit = function (token_1) {
        return __awaiter(this, arguments, void 0, function (token, idQueryInstallments, deferredPeriodIndex, gracePeriod) {
            var commitRequest;
